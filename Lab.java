package week3ArraysAndMethodsLab;
...
public class Lab {
	...
	public static void main(String[] args) {
		...
		//System.out.println(sixNums[6]);
		//out of bounds
		
		// 5. Print out the element in the array at position -1, what happens?
		//System.out.println(sixNums[-1]);
		//nothing
			
		// 6. Write a traditional for loop that prints out each element in the array
		System.out.println("Print each number in the array: ");
		for (int i = 0; i <= 5; i++) {
		...
		//I can't store a void into a string. 
		//14 stores the String as a return to be used at a later point in time.
